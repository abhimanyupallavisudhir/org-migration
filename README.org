...
(setq org-link-abbrev-alist
        '(("orgr" . "~/gdrive/Gittable/org/"))) ;; or whatever abbreviation you want
#+end_src
...
Then you can get links like [[orgr:relative/path/in/org/directory/][orgr:relative/path/in/org/directory]].
